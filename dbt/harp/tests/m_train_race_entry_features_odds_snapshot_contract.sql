...
actual_columns as (
  ...
  where table_schema = '{{ ref("m_train_race_entry_features").schema }}'
    and table_name = '{{ ref("m_train_race_entry_features").identifier }}'
),
...
invalid_values as (
  ...
  from {{ ref('m_train_race_entry_features') }}
