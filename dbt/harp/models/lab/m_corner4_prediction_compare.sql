...
target_rows as (
  select
    ...
    lf.horse_corner4_avg5,
    lf.horse_corner4_wavg5_recent,
    lf.horse_corner4_trend5,
    lf.horse_corner4_sd5
...
scored_rows as (
  select
    ...
    tr.horse_corner4_avg5,
    tr.horse_corner4_wavg5_recent,
    tr.horse_corner4_trend5,
    tr.horse_corner4_sd5,
    (
...
select
  ...
  sr.horse_corner4_avg5,
  sr.horse_corner4_wavg5_recent,
  sr.horse_corner4_trend5,
  sr.horse_corner4_sd5,
  sr.ols3_points,
  sr.ols3_slope,
  sr.ols3_intercept,
  ...
  least(greatest(sr.horse_corner4_avg5, 0), 1) as pred_avg5,
  least(greatest(sr.horse_corner4_wavg5_recent, 0), 1) as pred_wavg5_recent,
  least(
    greatest(
      case
        when sr.p1_corner4 is null or sr.horse_corner4_trend5 is null then null
        else sr.p1_corner4 - sr.horse_corner4_trend5
      end,
      0
    ),
    1
  ) as pred_endpoint_trend5,
  least(
    greatest(
      case
        when sr.horse_corner4_wavg5_recent is null or sr.horse_corner4_trend5 is null then null
        else sr.horse_corner4_wavg5_recent - sr.horse_corner4_trend5
      end,
      0
    ),
    1
  ) as pred_wavg5_plus_trend5
from scored_rows sr
