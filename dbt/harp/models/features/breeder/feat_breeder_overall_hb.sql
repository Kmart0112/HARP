...
params as (
  select
    0.213::float as prior_place_rate,
    20::float as prior_strength
)
...
select
  ...
  breeder_wins_5y,
  (
    (breeder_places_5y + (params.prior_place_rate * params.prior_strength))
    / nullif(breeder_starts_5y + params.prior_strength, 0)
  ) as breeder_place_rate_5y
