...
RUNS_CSV_PATH = (
    ...
    / "report"
    / "results"
    / f"{TODAY}_ten3f_vs_avg_past3_runs.csv"
)
RUN_LOG_DIR = PROJECT_ROOT / "outputs" / f"ten3f_vs_avg_past3_logs_{TODAY}"

P1_FEATURE = "p1_ten3f_vs_avg"
P2_FEATURE = "p2_ten3f_vs_avg"
P3_FEATURE = "p3_ten3f_vs_avg"
AVG_FEATURE = "ten3f_vs_avg_avg3"
...
def main() -> None:
    ...
    summary = {
        ...
        "set_only": set_row,
        "avg_only": avg_row,
        "restored_features_state": "baseline(added 4 features OFF)",
    }
